...
if __name__ == '__main__':
    ...
    print_deanonymization_stats(eu_transactions, intersection_kernels)
    print_deanonymization_stats(us_transactions, intersection_kernels)
    print_deanonymization_stats(he_transactions, intersection_kernels)
